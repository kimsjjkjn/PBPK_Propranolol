...
| CL_int | mL/min/mg microsomal protein | 0.13 | Hung, D.Y., et al., 2004. Disposition kinetics of propranolol isomers in the perfused rat liver. *The Journal of Pharmacology and Experimental Therapeutics*, 311(2), pp.822–829. https://doi.org/10.1124/jpet.104.070011 | - |
| fu_MP | - | 0.49 | Hung, D.Y., et al., 2004. Disposition kinetics of propranolol isomers in the perfused rat liver. *The Journal of Pharmacology and Experimental Therapeutics*, 311(2), pp.822–829. https://doi.org/10.1124/jpet.104.070011 | - |
...
- `CL_int_eff = 2710 ;mL/min`
  - Since `CL_int_eff = 2710` obtained from literature is already in the standard of whole blood concentration (at steady-state), there is no need to divide it by fu_MP - it is already scaled to in vivo. 
